...
export const TestsManagement = () => {
  ...
  const [activeTab, setActiveTab] = useState<"tests" | "questions">("questions");
  ...
  return (
    <Tabs defaultValue="questions" value={activeTab} onValueChange={(value) => setActiveTab(value as "tests" | "questions")}>
